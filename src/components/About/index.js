        ...
        <div className="text-zone">
          ...
          */}
          <p>
            ...
            eye for design and a strong foundation in modern web technologies.
            With experience in creating responsive, user-friendly interfaces and
            a commitment to continuous learning, I thrive on transforming
            creative ideas into engaging and functional web applications. My
            skill set includes JavaScript, Python, Sass, Firebase, and popular frameworks
            like React and Vue.js, enabling me to build seamless and dynamic
            user experiences. 
            </p>
              <p>Let's work together to bring your vision to life!
          </p>
        </div>
